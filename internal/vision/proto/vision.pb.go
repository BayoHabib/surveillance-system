...
// Request pour streamer les détections
type DetectionStreamRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CameraId      string                 `protobuf:"bytes,1,opt,name=camera_id,json=cameraId,proto3" json:"camera_id,omitempty"`
	IncludeFrames bool                   `protobuf:"varint,2,opt,name=include_frames,json=includeFrames,proto3" json:"include_frames,omitempty"` // Inclure les frames avec détections
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DetectionStreamRequest) GetCameraId() string {
	if x != nil {
		return x.CameraId
	}
	return ""
...
func (x *DetectionStreamRequest) GetIncludeFrames() bool {
	if x != nil {
...
// Request pour obtenir les frames du buffer
...
func (x *GetFramesRequest) GetCameraId() string {
	if x != nil {
		return x.CameraId
	}
	return ""
...
// Frame capturée (avec données brutes)
type Frame struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CameraId      string                 `protobuf:"bytes,1,opt,name=camera_id,json=cameraId,proto3" json:"camera_id,omitempty"`
	FrameNumber   int64                  `protobuf:"varint,2,opt,name=frame_number,json=frameNumber,proto3" json:"frame_number,omitempty"`
	Data          []byte                 `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"` // Données BGR raw (width * height * 3)
	Width         int32                  `protobuf:"varint,4,opt,name=width,proto3" json:"width,omitempty"`
	Height        int32                  `protobuf:"varint,5,opt,name=height,proto3" json:"height,omitempty"`
	Channels      int32                  `protobuf:"varint,6,opt,name=channels,proto3" json:"channels,omitempty"`                    // Toujours 3 pour BGR
	Format        string                 `protobuf:"bytes,7,opt,name=format,proto3" json:"format,omitempty"`                         // "bgr", "rgb", "gray"
	Timestamp     int64                  `protobuf:"varint,8,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                  // Milliseconds since epoch
	HasMotion     bool                   `protobuf:"varint,9,opt,name=has_motion,json=hasMotion,proto3" json:"has_motion,omitempty"` // Indique si mouvement détecté
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Frame) GetChannels() int32 {
	if x != nil {
		return x.Channels
	}
	return 0
...
func (x *Frame) GetHasMotion() bool {
	if x != nil {
		return x.HasMotion
	}
	return false
...
type DetectionEvent struct {
	...
	MotionPixels  int32                  `protobuf:"varint,5,opt,name=motion_pixels,json=motionPixels,proto3" json:"motion_pixels,omitempty"` // Nombre de pixels en mouvement
...
func (x *DetectionEvent) GetDetection() *Detection {
	if x != nil {
		return x.Detection
	}
	return nil
...
func (x *DetectionEvent) GetFrameNumber() int64 {
	if x != nil {
		return x.FrameNumber
	}
	return 0
...
func (x *DetectionEvent) GetMotionPixels() int32 {
	if x != nil {
		return x.MotionPixels
	}
	return 0
}
...
const file_vision_proto_rawDesc = "" +
	...
	"\x0fmemory_usage_mb\x18\x04 \x01(\x03R\rmemoryUsageMb\"\\\n" +
	"\x16DetectionStreamRequest\x12\x1b\n" +
	"\tcamera_id\x18\x01 \x01(\tR\bcameraId\x12%\n" +
	"\x0einclude_frames\x18\x02 \x01(\bR\rincludeFrames\"/\n" +
	"\x10GetFramesRequest\x12\x1b\n" +
	"\tcamera_id\x18\x01 \x01(\tR\bcameraId\"\xfa\x01\n" +
	"\x05Frame\x12\x1b\n" +
	"\tcamera_id\x18\x01 \x01(\tR\bcameraId\x12!\n" +
	"\fframe_number\x18\x02 \x01(\x03R\vframeNumber\x12\x12\n" +
	...
	"\bchannels\x18\x06 \x01(\x05R\bchannels\x12\x16\n" +
	"\x06format\x18\a \x01(\tR\x06format\x12\x1c\n" +
	"\ttimestamp\x18\b \x01(\x03R\ttimestamp\x12\x1d\n" +
	"\n" +
	"has_motion\x18\t \x01(\bR\thasMotion\"\xf4\x01\n" +
	"\x0eDetectionEvent\x12\x1b\n" +
	"\tcamera_id\x18\x01 \x01(\tR\bcameraId\x12!\n" +
	"\fdetection_id\x18\x02 \x01(\tR\vdetectionId\x12<\n" +
	"\tdetection\x18\x03 \x01(\v2\x1e.surveillance.vision.DetectionR\tdetection\x12!\n" +
	"\fframe_number\x18\x04 \x01(\x03R\vframeNumber\x12#\n" +
	"\rmotion_pixels\x18\x05 \x01(\x05R\fmotionPixels\x12\x1c\n" +
	"\ttimestamp\x18\x06 \x01(\x03R\ttimestamp2\x82\x05\n" +
	"\rVisionService\x12V\n" +
	...
	"\rProcessFrames\x12!.surveillance.vision.FrameRequest\x1a\".surveillance.vision.FrameResponse(\x010\x01\x12P\n" +
	"\tGetFrames\x12%.surveillance.vision.GetFramesRequest\x1a\x1a.surveillance.vision.Frame0\x01\x12f\n" +
	"\x10StreamDetections\x12+.surveillance.vision.DetectionStreamRequest\x1a#.surveillance.vision.DetectionEvent0\x01B)Z'surveillance-core/internal/vision/protob\x06proto3"
...
var file_vision_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_vision_proto_goTypes = []any{
	...
	(*DetectionStreamRequest)(nil), // 18: surveillance.vision.DetectionStreamRequest
	(*GetFramesRequest)(nil),       // 19: surveillance.vision.GetFramesRequest
	(*Frame)(nil),                  // 20: surveillance.vision.Frame
	(*DetectionEvent)(nil),         // 21: surveillance.vision.DetectionEvent
	nil,                            // 22: surveillance.vision.Detection.MetadataEntry
}
var file_vision_proto_depIdxs = []int32{
	...
	22, // 8: surveillance.vision.Detection.metadata:type_name -> surveillance.vision.Detection.MetadataEntry
	15, // 9: surveillance.vision.DetectionEvent.detection:type_name -> surveillance.vision.Detection
	3,  // 10: surveillance.vision.VisionService.StartStream:input_type -> surveillance.vision.StreamRequest
	5,  // 11: surveillance.vision.VisionService.StopStream:input_type -> surveillance.vision.StopRequest
	7,  // 12: surveillance.vision.VisionService.GetStreamStatus:input_type -> surveillance.vision.StatusRequest
	10, // 13: surveillance.vision.VisionService.GetHealth:input_type -> surveillance.vision.HealthRequest
	12, // 14: surveillance.vision.VisionService.ProcessFrames:input_type -> surveillance.vision.FrameRequest
	19, // 15: surveillance.vision.VisionService.GetFrames:input_type -> surveillance.vision.GetFramesRequest
	18, // 16: surveillance.vision.VisionService.StreamDetections:input_type -> surveillance.vision.DetectionStreamRequest
	4,  // 17: surveillance.vision.VisionService.StartStream:output_type -> surveillance.vision.StreamResponse
	6,  // 18: surveillance.vision.VisionService.StopStream:output_type -> surveillance.vision.StopResponse
	8,  // 19: surveillance.vision.VisionService.GetStreamStatus:output_type -> surveillance.vision.StatusResponse
	11, // 20: surveillance.vision.VisionService.GetHealth:output_type -> surveillance.vision.HealthResponse
	14, // 21: surveillance.vision.VisionService.ProcessFrames:output_type -> surveillance.vision.FrameResponse
	20, // 22: surveillance.vision.VisionService.GetFrames:output_type -> surveillance.vision.Frame
	21, // 23: surveillance.vision.VisionService.StreamDetections:output_type -> surveillance.vision.DetectionEvent
