...
const file_vision_proto_rawDesc = "" +
	...
	"\x0einclude_frames\x18\x02 \x01(\bR\rincludeFrames\"\xf4\x01\n" +
	...
	"\ttimestamp\x18\x06 \x01(\x03R\ttimestamp2\xb0\x04\n" +
	"\rVisionService\x12V\n" +
	...
	"\rProcessFrames\x12!.surveillance.vision.FrameRequest\x1a\".surveillance.vision.FrameResponse(\x010\x01\x12f\n" +
...
var file_vision_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_vision_proto_goTypes = []any{
	...
	(*DetectionEvent)(nil),         // 19: surveillance.vision.DetectionEvent
	nil,                            // 20: surveillance.vision.Detection.MetadataEntry
}
var file_vision_proto_depIdxs = []int32{
	...
	20, // 8: surveillance.vision.Detection.metadata:type_name -> surveillance.vision.Detection.MetadataEntry
	...
	18, // 15: surveillance.vision.VisionService.StreamDetections:input_type -> surveillance.vision.DetectionStreamRequest
	4,  // 16: surveillance.vision.VisionService.StartStream:output_type -> surveillance.vision.StreamResponse
	6,  // 17: surveillance.vision.VisionService.StopStream:output_type -> surveillance.vision.StopResponse
	8,  // 18: surveillance.vision.VisionService.GetStreamStatus:output_type -> surveillance.vision.StatusResponse
	11, // 19: surveillance.vision.VisionService.GetHealth:output_type -> surveillance.vision.HealthResponse
	14, // 20: surveillance.vision.VisionService.ProcessFrames:output_type -> surveillance.vision.FrameResponse
	19, // 21: surveillance.vision.VisionService.StreamDetections:output_type -> surveillance.vision.DetectionEvent
